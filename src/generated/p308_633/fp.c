...
static const uint64_t FP_P_MINUS_3_DIV_FOUR[FP_LIMBS] = { UINT64_C(0xffffffffffffffff), UINT64_C(0xffffffffffffffff), UINT64_C(0xffffffffffffffff), UINT64_C(0xffffffffffffffff), UINT64_C(0x09e3ffffffffffff) };
