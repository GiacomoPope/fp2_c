...
static const uint64_t FP_MODULUS[FP_LIMBS] = { UINT64_C(0xffffffffffffffff), UINT64_C(0xffffffffffffffff), UINT64_C(0xffffffffffffffff), UINT64_C(0x04ffffffffffffff) };
static const uint64_t FP_P0I = UINT64_C(0x0000000000000001);
static const uint64_t FP_P1 = UINT64_C(0x000000009fffffff);
static const uint64_t FP_P1DIV_M = UINT64_C(0x9999999c28f5c294);
static const fp_t FP_ONE = { .limb = { UINT64_C(0x0000000000000033), UINT64_C(0x0000000000000000), UINT64_C(0x0000000000000000), UINT64_C(0x0100000000000000) } };
static const fp_t FP_R2_ELEM = { .limb = { UINT64_C(0x3333333333333d70), UINT64_C(0x3333333333333333), UINT64_C(0x3333333333333333), UINT64_C(0x0333333333333333) } };
static const fp_t FP_TDEC_ELEM = { .limb = { UINT64_C(0x3333333333333333), UINT64_C(0x3333333333333333), UINT64_C(0x3333333333333333), UINT64_C(0x0100000000000033) } };
static const uint64_t FP_SQRT_EXP[FP_LIMBS] = { UINT64_C(0x0000000000000000), UINT64_C(0x0000000000000000), UINT64_C(0x0000000000000000), UINT64_C(0x0140000000000000) };
static const uint64_t FP_P_MINUS_3_DIV_FOUR[FP_LIMBS] = { UINT64_C(0xffffffffffffffff), UINT64_C(0xffffffffffffffff), UINT64_C(0xffffffffffffffff), UINT64_C(0x013fffffffffffff) };
static const size_t FP_NUM1 = 15;
static const size_t FP_NUM2 = 35;
static const fp_t FP_TFIXDIV = { .limb = { UINT64_C(0x49ba5e3bcd35a858), UINT64_C(0xf7ced916872b020c), UINT64_C(0x72b020c49ba5e353), UINT64_C(0x025e353f7ced9168) } };
