...
static const uint64_t FP_MODULUS[FP_LIMBS] = { UINT64_C(0xffffffffffffffff), UINT64_C(0xffffffffffffffff), UINT64_C(0xffffffffffffffff), UINT64_C(0xffffffffffffffff), UINT64_C(0xffffffffffffffff), UINT64_C(0xffffffffffffffff), UINT64_C(0xffffffffffffffff), UINT64_C(0xffffffffffffffff), UINT64_C(0xffffffffffffffff), UINT64_C(0x13cfffffffffffff) };
static const uint64_t FP_P0I = UINT64_C(0x0000000000000001);
static const uint64_t FP_P1 = UINT64_C(0x000000009e7fffff);
static const uint64_t FP_P1DIV_M = UINT64_C(0x9d79f179525582c9);
static const fp_t FP_ONE = { .limb = { UINT64_C(0x000000000000000c), UINT64_C(0x0000000000000000), UINT64_C(0x0000000000000000), UINT64_C(0x0000000000000000), UINT64_C(0x0000000000000000), UINT64_C(0x0000000000000000), UINT64_C(0x0000000000000000), UINT64_C(0x0000000000000000), UINT64_C(0x0000000000000000), UINT64_C(0x1240000000000000) } };
